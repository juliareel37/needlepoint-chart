      ...
      nextSession: {
        ...
        iconInteraction: {
          placement: {
            ...
            isUserUploaded: command.payload.isUserUploaded,
            ...
            primitiveSpacingScale: command.payload.primitiveSpacingScale,
            ...
            rotation: command.payload.rotation ?? 0,
          },
        },
      },
      nextUi: state.ui,
      ...
      nextSession: {
        ...
        iconInteraction: {
          placement: {
            ...
            mimeType: command.payload.mimeType ?? placement.mimeType,
            ...
            isUserUploaded: command.payload.isUserUploaded ?? placement.isUserUploaded,
            ...
            primitiveSpacingScale:
              command.payload.primitiveSpacingScale ?? placement.primitiveSpacingScale,
            selectedColorSlotId:
            ...
            scaleX: command.payload.scaleX ?? command.payload.scale ?? placement.scaleX,
            scaleY: command.payload.scaleY ?? command.payload.scale ?? placement.scaleY,
            rotation: command.payload.rotation ?? placement.rotation,
          },
        },
      },
      nextUi: state.ui,
